...
// Moved outside the class as a top-level constant
const List<Map<String, dynamic>> products = [
  {
    'name': 'Men\'s Jacket',
    'price': 49.99,
    'description': 'Stylish men\'s jacket suitable for all seasons.',
...
class FashionProductsPage extends StatelessWidget {
  const FashionProductsPage({super.key});
